...
There are a number of general MIDI driver settings. The [`midi.driver`](../settings/midi.md#settings_midi_driver) setting
...
**midi driver settings**, please refer to the `midi` documentation.
