...
Instead of creating an audio driver as described in section [Loading and playing a MIDI file](midi-player.md)
...
can be specified via the `settings` object as well. Refer to the
`audio` documentation for more `audio.file\.\*` options.
