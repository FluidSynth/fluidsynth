...
**FluidSynth** is a free software synthesizer. It's based on the [SoundFont](SoundFont.md) 2 specifications and supports real-time MIDI effect controls. It can be used as a shared library for embedding in other applications, can play MIDI files and has a command-line shell. Many other applications use FluidSynth for audio synthesis.
...
[MadeWithFluidSynth](MadeWithFluidSynth.md) is a page for users to post links to their Music and Audio creations made with FluidSynth. 
