...
function ( get_linker_flags_from_pkg_config _library _prefix _outvar )
  if ( "${_library}" MATCHES "${CMAKE_STATIC_LIBRARY_SUFFIX}$" )
    set ( _flags ${_prefix}_STATIC_LDFLAGS )
  else ()
    set ( _flags ${_prefix}_LDFLAGS )
  endif ()
  set ( ${_outvar} "${${_flags}}" PARENT_SCOPE )
endfunction ( get_linker_flags_from_pkg_config )
