...
#else
        FLUID_LOG(FLUID_WARNING, "Fluidsynth must be compiled against Pipewire 1.1.81 or newer to support asynchronous scheduling. Falling back to synchronous scheduling.");
