...
static fluid_jack_client_t *new_fluid_jack_client(fluid_settings_t *settings,
        int isaudio, void *driver, int flags);
...
new_fluid_jack_client(fluid_settings_t *settings, int isaudio, void *driver, int flags)
{
    ...
    {
        if (flags & FLUID_AUDRIVER_START_SERVER)
        {
...
new_fluid_jack_audio_driver(fluid_settings_t *settings, fluid_synth_t *synth, int flags)
{
    return new_fluid_jack_audio_driver2(settings, NULL, synth, flags);
}

fluid_audio_driver_t *
new_fluid_jack_audio_driver2(fluid_settings_t *settings,
                             ...
                             int flags)
{
    ...
    dev->client_ref = new_fluid_jack_client(settings, TRUE, dev, flags);
                           ...
                           int flags)
{
    ...
    dev->client_ref = new_fluid_jack_client(settings, FALSE, dev, flags);
