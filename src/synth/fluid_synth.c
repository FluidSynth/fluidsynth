...
static void fluid_synth_process_awe32_nrpn_LOCAL(fluid_synth_t *synth, int chan, int gen, int data, int data_lsb)
{
    ...
    switch(sf2_gen)
    {
        ...
        case GEN_REVERBSEND:
            ...
            converted_sf2_generator_value = fluid_mod_transform_source_value(NULL, data, default_reverb_mod.flags1, 256);
        ...
        case GEN_CHORUSSEND:
            fluid_clip(data, 0, 255);
            /* transform the input value */
            converted_sf2_generator_value = fluid_mod_transform_source_value(NULL, data, default_chorus_mod.flags1, 256);
